...
const routing = {
    'GET': {
        ...
        '/reports': reportsControllers.reports,
        '/reports/annual': reportsControllers.annualReports,
        '/reports/monthly': reportsControllers.monthlyReports
    },
    'POST': {
        '/user/add': reportsControllers.addUser,
    ...
    'PUT': {
        ...
        '/upload-patients': uploadController.saveClients,
