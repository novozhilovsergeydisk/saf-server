...
const Constrainer = require('./lib/constrainer.js')
...
// Router.prototype.post = function post (req, res, ctx) {
//     log('post')
// }

Router.prototype.lookup = function lookup (req, res, ctx) {
    log('lookup')
    const handle = this.find(req.method, req.url, this.constrainer.deriveConstraints(req, ctx))
...
Router.prototype.lookup__ = function lookup__ (req, res, ctx) {
