...
ALTER TABLE crm.records
ADD FOREIGN KEY (user_id) REFERENCES crm.users(id) ON DELETE cascade
;

alter table crm.records drop column user_id
;
...
alter table crm.recordspay drop column user_id
;
